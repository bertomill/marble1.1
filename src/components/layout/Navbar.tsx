    ...
    <nav className="flex items-center justify-between p-4 border-b border-gray-800">
      <div className="flex items-center space-x-8">
        <Link href="/" className="flex items-center space-x-2">
          ...
          <span className="font-bold">Marble UI</span>
      ...
      <div className="flex items-center space-x-4">
        <a
          href="https://github.com/yourusername/marble-ui"
          className="flex items-center space-x-2 bg-gradient-to-r from-gray-800 to-gray-700 rounded-full px-4 py-1.5"
        >
      ...
      {/* Mobile menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-gray-900 border-b border-gray-800 p-4 z-50">
          <div className="flex flex-col space-y-3">
            <Link href="/components" className="text-gray-300 hover:text-white py-2">
              Components
            </Link>
            <Link href="/templates" className="text-gray-300 hover:text-white py-2">
              Templates
            </Link>
            <Link href="/showcase" className="text-gray-300 hover:text-white py-2">
              Showcase
            </Link>
          </div>
        </div>
